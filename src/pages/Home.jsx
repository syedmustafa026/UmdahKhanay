            ...
            <div className="container">
                ...
                <div className="gallery">
                    <section className="text-gray-600 body-font">
                        <p className="heading text-2xl min- font-semibold capitalize text-main relative before:absolute before:rounded-lg before:content before:w-32 ml-24 before:h-1 before:-bottom-2 before:left-0 before:bg-gradient-to-tr from-main to-main-700 transition-all ease-in-out duration-100">
                           Our Responsiblities
                        </p>
